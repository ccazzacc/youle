        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.apply_btnCommit:
                	...
                	if(OtherUtil.isNullOrEmpty(mEdName.getText().toString()) || OtherUtil.isNullOrEmpty(mEdPhone.getText().toString())||OtherUtil.isNullOrEmpty(mEdLicense.getText().toString())
                			||OtherUtil.isNullOrEmpty(mEdCarNo.getText().toString())||OtherUtil.isNullOrEmpty(mEdCompany.getText().toString()))
                	{
    ...
    private class AppTaxiTask extends AsyncTask<Void, Void, String>
    {
		...
		protected void onPostExecute(String result) {
			...
			if(!OtherUtil.isNullOrEmpty(result) && result.startsWith(GlobalData.RESULT_OK))
			{
				...
				ToastUtil.showToast(ApplyTaxiActivity.this, getString(R.string.apply_success));
		...
		protected String doInBackground(Void... params) {
			// TODO Auto-generated method stub
			return YouLe.applyTaxi(ApplyTaxiActivity.this, new SharedPref(ApplyTaxiActivity.this).getRadioId()+"", mEdName.getText().toString(), mEdPhone.getText().toString(),
					mEdLicense.getText().toString(), mEdCompany.getText().toString(), mEdCarNo.getText().toString());
		}
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			CustomProgressDialog.showMsg(ApplyTaxiActivity.this, getString(R.string.please_wait));
		}
