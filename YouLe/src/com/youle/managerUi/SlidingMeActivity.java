...
public class SlidingMeActivity extends FragmentActivity implements SlidingActivityBase {
	...
	private SlidingMeActivityHelper mHelper;

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		mHelper = new SlidingMeActivityHelper(this);
