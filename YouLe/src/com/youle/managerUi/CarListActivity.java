...
public class CarListActivity extends StatActivity{
	...
	{
		lvCar = (ListView)findViewById(R.id.car_listLv);
		...
		carList.add(new CarListDetailInfo("http://api.pathtrip.com/avatars/128/1000108.png", "明天汽油降价了！","http://api.pathtrip.com/avatars/128/1000033.png","","test", "145", "5分钟前"));
		carList.add(new CarListDetailInfo("http://api.pathtrip.com/avatars/128/1000095.png", "啦啦啦啦啦！豆腐干大概入土为儿童的发放的发改委特的发生大幅的人反而佛挡杀佛是的发生的的few的发生的日是的粉色二万人的发生大幅","","","aaa", "552", "6分钟前"));
		carList.add(new CarListDetailInfo("http://api.pathtrip.com/avatars/128/1000033.png", "阿凡达是广东分公司大的说法撒旦法梵蒂冈梵蒂冈斯蒂芬豆腐干豆腐干斯蒂芬否斯蒂芬斯蒂芬但是打发似的","http://api.pathtrip.com/avatars/128/1000095.png","","热啊", "7852", "8分钟前"));
		carList.add(new CarListDetailInfo("http://api.pathtrip.com/avatars/128/1000069.png", "月份汇丰供货商反观对手犯规","","","而俺是", "451", "9分钟前"));
