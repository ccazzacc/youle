...
public class MainMapActivity extends SlidingMapActivity {
    ...
    private void setViewAttrs() {
        ...
        this.setContentView(R.layout.map_center_fragment);

        this.setLeftContentView(R.layout.map_left_fragment);
