...
public class SlidingMapActivityHelper {
	...
	public SlidingMapActivityHelper(Activity activity) {
		mActivity = activity;
	}

	public void onCreate(Bundle savedInstanceState) {
		mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.slidingmap, null);
...
//			}
	...
	public void showLeft() {
		mSlidingMenu.showLeft(true);
	}
	public void showRight() {
		mSlidingMenu.showRight(true);
	}
}
