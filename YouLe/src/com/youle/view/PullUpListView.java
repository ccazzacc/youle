...
public class PullUpListView extends ListView implements OnScrollListener {
	...
	private final int PULL_LOAD_MORE_DELTA = 50; // when pull up >= 50px
														// at bottom, trigger
														// load more.
	private final float OFFSET_RADIO = 1.8f; // support iOS like pull
													// feature.
...
//				mHeaderView.setVisiableHeight(mScroller.getCurrY());
	...
	public void setXListViewListener(PullListViewListener l) {
		mListViewListener = l;
	}
